      ...
      <div className="px-4 py-3 bg-white border-t border-parchment-200">
        <div className="flex gap-2 items-end">
          <textarea
            ...
            placeholder="Share your thoughts or answer Sage's question…"
            rows={2}
...
function MessageBubble({ msg, studentName }: MsgProps) {
  ...
  if (msg.tool) {
    // Tool-generated message (narration prompt, hint, celebration, faith connection)
  ...
  return (
    <div className={`flex ${isUser ? 'justify-end' : 'justify-start'} animate-fade-in`}>
      ...
      >
        {!isUser && (
          <div className="text-xs font-semibold text-sage-600 mb-1">Sage</div>
        )}
        {isUser && (
          <div className="text-xs font-semibold text-sage-100 mb-1">{studentName}</div>
        )}
